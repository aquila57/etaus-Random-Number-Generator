/* etausnorm.c - etaus Gaussian distribution Version 1.0.0           */
...
void boxmul(etfmt *et, double mean,
...
int main(int argc, char **argv)
   ...
   et = (etfmt *) etausinit();   /* initialize etaus to date/time */
   ...
   while (i--)
      {
      boxmul(et,mean,stdev,aa);        /* Box-Muller Transform */

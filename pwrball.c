...
int main()
   ...
   char maindraw[128];
   char bonuspool[64];
   et = (etfmt *) etausinit();   /* initialize etaus generator */
   ...
   *p = 1;
   ...
   free(et->state);    /* free state array */
